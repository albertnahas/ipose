    ...
    <>
      ...
      <Box sx={{ textAlign: "left" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Account</strong> means any user profile You hold with Us.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to IPose.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to IPose, accessible from{" "}
              <ControlLink to="/">https://IPose.com</ControlLink>.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            <p>
              If you have been previously banned from accessing our Service, you
              are prohibited from re-accessing the Service.
            </p>
          </li>
          <li>
            <p>
              You are prohibited from using our Service for commercial purposes.
            </p>
          </li>
          <li>
            <p>
              You are prohibited from using our Service to advertise, solicit,
              or transmit any commercial advertisements, which include but are
              not limited to chain letters, junk, spam, or repetitive messaging
              (both targeted and un-targeted).
            </p>
          </li>
          <li>
            <p>
              You are prohibited from creating an Account on someone else’s
              behalf.
            </p>
          </li>
          <li>
            <p>
              You are prohibited from creating an Account using inaccurate or
              false information.
            </p>
          </li>
          <li>
            <p>
              You are prohibited from renting, selling, gifting, or giving away
              your Account or Account-related information.
            </p>
          </li>
        </ul>
        <p>You further agree that under no circumstance will you:</p>
        <ul>
          <li>
            <p>
              Engage in acts that are inappropriate and/or in conflict with the
              spirit or intent of the Service or these Terms.
            </p>
          </li>
          <li>
            <p>
              Copy or reproduce (except as expressly permitted), translate,
              reverse engineer, derive source code from, modify, disassemble,
              decompile, or create derivative works based on or related to the
              Service.
            </p>
          </li>
          <li>
            <p>
              Use our Service to post, supply or make available any material or
              information that infringes on any copyright, trademark, patent,
              trade secret, right of privacy, right of publicity, or any other
              right of a person or entity.
            </p>
          </li>
          <li>
            <p>Scrape, harvest, or extract data from the Service.</p>
          </li>
          <li>
            <p>
              Seek to obtain advantage or information from our Service using
              methods not expressly permitted by IPose.
            </p>
          </li>
          <li>
            <p>
              Create, use, offer, promote, advertise, make available, and/or
              distribute exploits, cheats, bots, software, hacks, mods or any
              unauthorized third party code or software that can be used to
              interfere with, alter or modify our Service, or that can be used
              in conjunction with our Service.
            </p>
          </li>
          <li>
            <p>
              Impersonate another person, including without limitation any other
              user or any IPose employee.
            </p>
          </li>
        </ul>
        <ControlHeading2 variant="h2" color="primary">
        ...
        <p>
          ...
          password (collectively known as “Login Information”). You are
          responsible for all use of the Service and activity related to your
          Account, including all transactions and payments associated with that
          Account (which may include but are not limited to the use of your
          credit card and other payment systems such as PayPal). You agree to
          maintain accurate, complete, and up-to-date information in your
          Account, and our Privacy Policy describes how you can keep your
          personal information up-to-date. It is your sole responsibility to
          maintain the confidentiality of your Login Information. You agree not
          to engage in any acts that may compromise the integrity, fair play
          and/or security of your Account, including but not limited to sharing
          Login Information or permitting unauthorized access, loss, or theft.
          If you learn or suspect that your Account has been compromised, please
          contact us immediately. We also urge you to modify your Login
          Information to prevent further damage. We will not be responsible to
          you for any losses or harm you may suffer as a result of an
          unauthorized person accessing your Account and/or using your Login
        ...
        <p>
          ...
          our Service and any other parties with whom you interact through the
          Service. We reserve the right, but have no obligation, to become
          involved with any disputes related to those interactions. You agree to
          fully cooperate with us to investigate any suspected unlawful,
          fraudulent or improper activity, including, without limitation, by
          granting us access to any password-protected portions of your Account
          as may be required. If you have a dispute with any other user(s), you
          release us from claims, demands and damages (actual and consequential)
          of every kind and nature, known and unknown, arising out of or related
          to such disputes.
        </p>
        <p>
          We reserve the right to reclaim and/or remove any usernames at our
        ...
        <p>
          ...
          If you choose to exercise this right, please inform IPose that you
        ...
        <p>
          ...
          Company, on its own behalf and its respective licensors and service
        ...
        <ul>
          <li>
            <p>
              ...
              <ControlLink to="/contact">https://IPose.com/contact</ControlLink>
            </p>
          </li>
        </ul>
      </Box>
